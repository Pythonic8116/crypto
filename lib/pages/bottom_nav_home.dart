            ...
            tabBuilder: (context, index) {
              switch (index) {
                case 0:
                  return HomeScreen();
                case 1:
                  return P2PMarketPlace(url: P2PURL);
                case 2:
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: BottomNavigationBar(
              ...
              items: [
                ...
                BottomNavigationBarItem(icon: Icon(Icons.group), label: 'P2P'),
                BottomNavigationBarItem(
                  icon: Icon(Icons.settings),
                  label: 'Settings',
                ),
              ...
              child: Column(
                children: [
                  ...
                  ModalWid(
                    ...
                    desc: 'Buy and Sell Crypto from trusted sources...',
                    icon: Icons.group,
                    isSend: false,
                    ...
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => P2PMarketPlace(url: P2PURL),
                        ),
                      );
                    },
                    // page: '/p2p-marketplace/',
                  )
                ],
              ),
            ),
